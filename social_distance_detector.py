...
print("1: Video1\n2: Video2\n3: Video3")
a=int(input("Enter the videostream of Prefrence "))
if (a==1):
	args = vars(ap.parse_args(["--input","input1.mp4","--output","output100.mp4"]))
elif (a==2):
		args = vars(ap.parse_args(["--input","input2.mp4","--output","output100.mp4"]))
else:    
	args = vars(ap.parse_args(["--input","input3.mp4","--output","output100.mp4"]))
